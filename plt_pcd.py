...
cyc_dula = np.load('figs/ising_learn/rmse_cyc_dula_0.25_100.npy')
...
plt.plot(x, cyc_dula, lw=1, label='CYC_DULA')
...
cyc_dulat = np.load('figs/ising_learn/times_cyc_dula_0.25_100.npy')
...
plt.plot(cyc_dulat, cyc_dula, lw=2, label='CYC_DULA')
